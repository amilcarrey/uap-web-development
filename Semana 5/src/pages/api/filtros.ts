...
export const GET: APIRoute = async ({ request, redirect }) => {
  ...
  const boardId = url.searchParams.get("activeBoardId"); // Obtiene el ID del tablero de la URL
  ...
  let filteredTasks = allTasks.filter((task) => task.boardId === boardId); // Inicializa filteredTasks con todas las tareas
