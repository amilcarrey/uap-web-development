        ...
        switch (_a.label) {
            case 0:
                ...
                if (!input || !input.value.trim())
                    return [2 /*return*/];
                nuevaTarea = { nombre: input.value.trim() };
                return [4 /*yield*/, fetch("/api/tareas", {
                        method: "POST",
                        headers: {
            ...
            case 1:
                ...
                input.value = "";
                return [4 /*yield*/, cargarTareas()];
            case 2:
                _a.sent(); // <- recarga toda la lista
                return [3 /*break*/, 4];
            case 3:
...
function cargarTareas() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("/api/tareas")];
                case 1:
                    res = _a.sent();
