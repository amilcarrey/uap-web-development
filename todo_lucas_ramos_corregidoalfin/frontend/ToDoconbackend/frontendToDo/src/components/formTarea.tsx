...
export const FormTarea = ({ tableroId }: Props) => {
  ...
  return (
    <form
      id="form-tarea"
      className="flex justify-center mb-3 mt-4 max-w-lg mx-auto"
    ...
    >
      <input
        ...
        className="p-2 w-3/4 rounded-lg border border-gray-300 text-lg focus:outline-none focus:ring focus:ring-blue-300"
        placeholder="Nombre de la tarea"
        required
      />
      <button
        type="submit"
        className="ml-2 p-2 bg-blue-500 text-white rounded-lg hover:bg-blue-700 transition"
        disabled={isPending}
      >
